...
public class GoogleCal extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        year = intent.getStringExtra("년");
        month = intent.getStringExtra("월");
        day = intent.getStringExtra("일");
        mDay = intent.getStringExtra("m일");
        ...
        mtitle = (EditText) findViewById(R.id.cal_title); //일정 제목
        mSchedule = (EditText) findViewById(R.id.schedule); //일정
        mResultText = (TextView) findViewById(R.id.textview_main_result); //조회
...
//            mSchedule.setText(summ);
        ...
        private String getEvent() throws IOException, ParseException {
            ...
            if ( calendarID == null ){
                Toast.makeText(this.mActivity,"캘린더를 먼저 생성하세요.", Toast.LENGTH_SHORT);
                return "";
            }
        ...
        private String createCalendar() throws IOException {
            ...
            String summ = mtitle.getText().toString();
            if ( ids != null ){
                Toast.makeText(this.mActivity,"이미 캘린더가 생성되었습니다.", Toast.LENGTH_SHORT);
                return "";
            }
            ...
            // 새로 추가한 캘린더의 ID를 리턴
            Toast.makeText(this.mActivity,"캘린더가 생성되었습니다.", Toast.LENGTH_SHORT);
            return "";
        }
...
//                    mSchedule.setText("MakeRequestTask The following error occurred:\n" + mLastError.getMessage());
        ...
        private String addEvent() throws ParseException {
            ...
            System.out.println(datestr);        // Date 객체를 선언해서 String으로 변환한다.
